  ...
  return (
    ...
    >
      <div className="flex min-h-0 items-center gap-1.5 border-b border-[var(--border)] px-2 py-1">
        <Robot size={12} className="shrink-0 text-[var(--muted-foreground)]" />
        <span className="truncate text-xs font-medium">{label}</span>
        <span className="rounded bg-[var(--muted)] px-1 py-0.5 font-mono text-[8px] text-[var(--muted-foreground)]">
          {slug}
        </span>
      ...
      <div className="border-t border-[var(--border)] px-2 py-1">
        <span className="rounded bg-[var(--foreground)] px-2 py-0.5 text-[8px] text-[var(--background)]">
          Play
        </span>
      </div>
    </div>
